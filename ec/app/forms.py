...
#     password1=forms.CharField(label='Passowrd', widget=forms.PasswordInput(attrs={'class':
#     'form-control'}))
#     password2=forms.CharField(label='Confirm Passowrd', widget=forms.PasswordInput(attrs={'class':
#     'form-control'}))
from django import forms
